...
import { getIsActive, getIsMusicActive, getIsSoundActive } from '../../store/burger/selectors';
import { setSoundVolume, toggleIsMenuActive, toggleIsMusic, toggleIsSound } from '../../store/burger/burgerReducer';
