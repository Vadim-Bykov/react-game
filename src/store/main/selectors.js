export const getCards = (state) => state.main.cards;
export const getFlipped = (state) => state.main.flipped;
...
export const getGameInProgress = (state) => state.main.gameInProgress;
